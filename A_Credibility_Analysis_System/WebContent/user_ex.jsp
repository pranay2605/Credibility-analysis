        ...
        <div class="about" id="about">
            <div class="container">
                <div class="about-main">
                    <center><h4>Get User Search History </h4></center>
                            ...
                            <table id="customers">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        String sql = "SELECT * FROM user_exp where uid='" + id + "'";
                                ...
                                <td style="color: darkblue"><center><%=rs.getString("state")%></center></td>
                                <td style="color: darkblue"><center><%=rs.getString("counrty")%></center></td>
                                <td style="color: darkblue"><center><%=rs.getString("skeyword")%></center></td>
                                </tr>
                                <%
                                        }
                                    } catch (Exception ex) {
